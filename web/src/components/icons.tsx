...
/** A speech bubble: a message on its way to someone. */
export const IconChat = (p: P) => (
  <I {...p}>
    <path d="M20 12.3a7.7 7.7 0 0 1-11.3 6.8L4.4 20l1.3-4A7.7 7.7 0 1 1 20 12.3z" />
  </I>
);

/** The GitHub mark, filled: a brand, drawn as the brand draws it. */
