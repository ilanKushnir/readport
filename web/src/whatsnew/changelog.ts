...
export const CHANGELOG: ChangelogRelease[] = [
  {
    ...
    items: [
      ...
      { emoji: '📱', key: 'pairingOnPhone' },
    ],
  },
  {
    version: '0.27.0',
    items: [
      { emoji: '🎧', key: 'audiobookNames' },
      { emoji: 'ℹ️', key: 'bookMetadata' },
    ],
  },
  {
    version: '0.26.0',
    items: [
      { emoji: '🖼️', key: 'coverSuggestions' },
      { emoji: '📝', key: 'aboutLaidOut' },
      { emoji: '🌐', key: 'languageSearch' },
      { emoji: '👇', key: 'dragSheets' },
    ],
  },
  {
    version: '0.25.0',
    items: [
      { emoji: '🌍', key: 'otherLanguages' },
      { emoji: '🔎', key: 'passageIn' },
    ],
  },
  {
    version: '0.24.0',
    items: [{ emoji: '🔄', key: 'updateCard' }],
  },
  {
    version: '0.23.0',
    items: [{ emoji: '📖', key: 'turnWithVoice' }],
  },
  {
    version: '0.22.0',
    items: [
      { emoji: '📶', key: 'offlineSurvives' },
      { emoji: '🗜️', key: 'audiobookZip' },
      { emoji: '📜', key: 'scrollByPassage' },
      { emoji: '🙈', key: 'hiddenBooks' },
    ],
  },
  {
    version: '0.21.0',
