...
- **Alignment by forced alignment, not transcription**: the words are
  ...
  about 7% of the audio through the model and timed an hour-long book in a little over a minute
  and one of more than thirty hours in under half an hour — roughly six minutes for a
